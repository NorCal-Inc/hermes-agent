...
# The shared boot result is the single runtime authority. Static parity checks
# remain available as bounded tests but do not run as a separate session gate.
